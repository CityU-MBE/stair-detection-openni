/**
 * @file   table_detect.cpp
 * @edited by Haoyang Ye [hyyezju@gmail.com]
 * It can be the table detection
 */
            ...
            */
            ...
            while (inCloud->points.size () > 0.3 * nr_points) {
                ...
                if ( abs(costheta) > 0.8 ) {
                    ...
                    std::cout << "\033[1;32mbold TABLE TABLE TABLE TABLE!!!! height of table is \033[0m\n" <<  - coefficients->values[3] << "m." << std::endl;
                    // pcl::PCDWriter writer;
                    // writer.write<pcl::PointXYZ> ("/home/hyye/Desktop/stair/pcd/T1_table.pcd", *cloud_p);
